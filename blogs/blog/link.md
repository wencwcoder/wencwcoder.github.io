...
- 稀土掘金：[https://juejin.cn/](https://juejin.cn/)（面向全球中文开发者的技术内容分享与交流平台）
...
- React：[https://legacy.reactjs.org/](https://legacy.reactjs.org/)（旧地址）、[https://react.docschina.org/](https://react.docschina.org/)、[https://zh-hans.reactjs.org/](https://zh-hans.reactjs.org/)
- React：[https://react.dev/](https://react.dev/)、[https://react.jscn.org/](https://react.jscn.org/)
- Vue2.x：[https://v2.vuejs.org/](https://v2.vuejs.org/)、[https://v2.cn.vuejs.org/](https://v2.cn.vuejs.org/)
...
- Axios：[https://axios-http.com/](https://axios-http.com/)、[https://axios-http.com/zh/](https://axios-http.com/zh/)（基于 promise 的网络请求库）
