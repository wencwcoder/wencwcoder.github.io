...
- 项目生态完善（插件、工具）：【1】Vuex 的数据本地持久化插件；【2】接口数据的 mock， json-server；【3】 埋点的 sdk；【4】@vueuse 库，封装常用的 hooks；【5】Vite 相关的项目：https://github.com/vitejs/awesome-vite；【6】WindiCSS：https://antfu.me/posts/reimagine-atomic-css-zh；【7】SSR 的适用场景是首屏 or SEO
